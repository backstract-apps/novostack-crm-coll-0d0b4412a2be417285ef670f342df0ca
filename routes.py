...
def create_addresses(id: int, street: str, city: str, state: str, country: str, postal_code: str, created_at: str, updated_at: str, db: Session = Depends(get_db)):
...
def update_addresses_by_id(id: int, street: str, city: str, state: str, country: str, postal_code: str, created_at: str, updated_at: str, db: Session = Depends(get_db)):
