...
def create_addresses(db: Session, id: int, street: str, city: str, state: str, country: str, postal_code: str, created_at: str, updated_at: str):
...
def update_addresses_by_id(db: Session, id: int, street: str, city: str, state: str, country: str, postal_code: str, created_at: str, updated_at: str):
